...
final appTheme = ThemeData.light().copyWith(
  ...
  primaryColor: const Color.fromRGBO(128, 150, 255, 1),
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(
      foregroundColor: const Color.fromRGBO(128, 150, 255, 1),
    ),
  ),
  ...
  inputDecorationTheme: InputDecorationTheme(
    floatingLabelStyle: const TextStyle(
      color: const Color.fromRGBO(128, 150, 255, 1),
    ),
    ...
    focusColor: const Color.fromRGBO(128, 150, 255, 1),
